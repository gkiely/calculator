...
// import { componentIdFactory, componentNames, isOperator } from '../utils';
...
// console.log(componentIdFactory, isOperator, componentNames);
// const [id, resetId] = componentIdFactory();
