...
export const componentNames = (Object.keys(components) as Array<
  ComponentName
>).reduce(
  (acc, component) => ({
    ...acc,
...
export const getComponent = (
  ...
  const Component = components[data.component] as React.ComponentType<{
    location: Location;
  }>;
  ...
  return Component ? (
    <Component key={data.id} {...data.props} location={location} />
  ) : null;
};
